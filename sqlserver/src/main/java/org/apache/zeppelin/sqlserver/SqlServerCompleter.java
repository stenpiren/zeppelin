...
/**
 * SQL auto complete functionality for the SqlServerInterpreter.
 */
public class SqlServerCompleter extends StringsCompleter {
  ...
  public SqlServerCompleter(Set<String> allCompletions, Set<String> dataModelCompletions) {
